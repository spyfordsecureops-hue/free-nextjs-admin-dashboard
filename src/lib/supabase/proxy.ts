...
export async function updateSession(request: NextRequest) {
  ...
  try {
    ...
    // If any error occurs (e.g., invalid credentials), just return a basic response
    // This allows the app to continue functioning even if Supabase encounters issues
    return NextResponse.next({
      request,
    })
  }
