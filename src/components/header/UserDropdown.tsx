    ...
    <div className="relative">
      ...
      >
        <div>
          ...
          {profile?.role && (
            <span className="inline-block mt-1 px-2 py-0.5 text-xs font-medium rounded bg-brand-100 text-brand-600 dark:bg-brand-900/20 dark:text-brand-400">
              {profile.role}
            </span>
          )}
        </div>
